...
Python 不支持单字符类型，单字符在 Python 中也是作为一个字符串使用。这与java有所不同。

Python 访问子字符串，可以使用方括号 **[]** 来截取字符串，字符串的截取的语法格式

> 这跟bash中的字符串操作很像，不愧都是脚本语言
...
![CleanShot 2024-05-20 at 09.58.51@2x](https://kuiqwang.oss-cn-chengdu.aliyuncs.com/blog/CleanShot%202024-05-20%20at%2009.58.51@2x.png)
...
![CleanShot 2024-05-20 at 10.07.42@2x](https://kuiqwang.oss-cn-chengdu.aliyuncs.com/blog/CleanShot%202024-05-20%20at%2010.07.42@2x.png)
